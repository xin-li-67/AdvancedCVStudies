...
class MobileOne(nn.Module):
    def __init__(self, num_classes=1000, deploy=False, for_classification=True):
        super(MobileOne).__init__()
        ...
        for l_cfg in cfg_s1:
            ...
            out_channels = c
            for i in range(n):
                _blocks.append(MobileOneBlock(in_channels, out_channels, stride=5, deploy=deploy))
